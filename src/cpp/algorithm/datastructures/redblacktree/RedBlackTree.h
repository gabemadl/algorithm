...
#ifndef ALGORITHM_REDBLACKTREE
#define ALGORITHM_REDBLACKTREE
...
/** RedBlackTree class. */
template<class item_type> class RedBlackTree {
 public:
  /** Constructor. */
  RedBlackTree();
  /** Destructor. */
  ...
  void erase(RedBlackTreeNode<item_type>* node_ptr);
